...
The image is published for `linux/amd64` and `linux/arm64`, so the same tag works on an x86 server, a Raspberry Pi 4/5 and an Apple Silicon Mac.
...
- This version converts to MIT License on 2029-08-25.
