...
def build_chat_messages(
    ...
    web_instructions = (
        ...
        "it ends:\n"
        "- Pages come back as markdown with their links intact. When a page "
        "points at the detail you were asked about instead of containing it, "
        "call read_webpage again on that link. Keep going until you can answer "
