...
def build_chat_messages(
    ...
    web_instructions = (
        ...
        "translating).\n"
        "- A truncation marker means the page continues past what you were "
        "shown. Read the same URL again with a query naming what you need, or "
        "a section from the outline you were given; if that still misses, look "
        "for a more specific URL (a sub-page, a raw or API version). Never "
        "answer from the fragment.\n"
