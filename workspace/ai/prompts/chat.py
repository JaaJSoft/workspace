...
def build_chat_messages(
    ...
    web_instructions = (
        ...
        "shown. When the part you need is likely below the cut, look for a "
        "more specific URL (a sub-page, a raw or API version) rather than "
        "answering from the fragment.\n"
