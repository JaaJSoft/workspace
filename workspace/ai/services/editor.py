"""Editor AI actions (body of the ``ai.editor_action`` Celery task).

Supports four actions: improve, explain, summarize, custom.
"""
...
def run_editor_action(task_id: str) -> dict:
    """Run an AI action (improve/explain/summarize/custom) on editor content.
