...
window.pollDetail = function(pollId, csrfToken) {
  return {
    ...
    voteIcon(choice) { return pollUtils.voteIcon(choice); },
    chosenSlot() { return pollUtils.chosenSlot(this.poll); },
    isChosenSlot(slotUuid) { return pollUtils.isChosenSlot(this.poll, slotUuid); },
    ...
    formatSlotDate(slot) { return pollUtils.formatSlotDate(slot); },
    formatSlotTime(slot) { return pollUtils.formatSlotTime(slot); },
