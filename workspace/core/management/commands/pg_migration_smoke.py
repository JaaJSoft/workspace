...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        group.add_argument("--verify", action="store_true", help="Assert data matches expectations.")
    ...
    def _seed(self):
        ...
        account = MailAccount.objects.create(
            owner=alice, email=SEED_MAIL_EMAIL,
        ...
        Event.objects.create(
            calendar=cal, owner=alice, title="Smoke Event",
        ...
        File.objects.create(name="smoke.txt", owner=bob, node_type="file", parent=folder)
    ...
    def _verify(self):
        ...
        if not MailLabel.objects.filter(account=account, name=SEED_CUSTOM_LABEL).exists():
