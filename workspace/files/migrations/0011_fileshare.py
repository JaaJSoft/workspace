...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('files', '0010_populate_mime_type_rules'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['shared_with', 'created_at'], name='file_share_recv_idx')],
                'constraints': [models.UniqueConstraint(fields=('file', 'shared_with'), name='unique_file_share')],
            },
        ),
    ]
