...
class FileEventsListTests(APITestCase):
    ...
    def test_returns_events_newest_first(self):
        ...
        self.assertEqual(
            [e["action"] for e in data["results"]], ["shared", "renamed", "created"]
        )
    ...
    def test_pagination_limit_and_offset(self):
        ...
        response = self.client.get(
            f"/api/v1/files/{self.file.uuid}/events?limit=2&offset=1"
        )
    ...
    def test_invalid_limit_falls_back_to_default(self):
        ...
        response = self.client.get(
            f"/api/v1/files/{self.file.uuid}/events?limit=garbage"
        )
    ...
    def test_unknown_uuid_returns_404(self):
        response = self.client.get(
            "/api/v1/files/00000000-0000-0000-0000-000000000000/events"
        )
