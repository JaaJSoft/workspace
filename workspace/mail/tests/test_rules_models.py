...
from workspace.mail.models import MailFolder, MailMessage, MailRuleLog
...
class MailRuleLogModelTests(TestCase):
    def setUp(self):
        ...
        self.account = MailAccount.objects.create(
            owner=self.user, email='l@x.com',
            imap_host='x', smtp_host='x', username='l@x.com',
        )
