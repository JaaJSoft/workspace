...
urlpatterns = [
    ...
    path('api/v1/mail/labels', views.MailLabelListView.as_view(), name='mail-label-list'),
    path('api/v1/mail/labels/<uuid:uuid>', views.MailLabelDetailView.as_view(), name='mail-label-detail'),
    ...
    path('api/v1/mail/messages/<uuid:uuid>/labels', views.MailMessageLabelView.as_view(), name='mail-message-labels'),
