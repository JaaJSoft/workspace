...
class TaskPanelViewTests(SettingsCleanupMixin, ProjectTestMixin, TestCase):
    ...
    def test_archived_project_renders_read_only(self):
        ...
        # control must be disabled: the status, priority, epic, milestone,
        # start-date and due-date fields and the checklist item checkbox.
        ...
        self.assertEqual(self._count_disabled(resp), 7)
