...
api_urlpatterns = [
    ...
    path("", include("workspace.people.urls")),
    path("", include("workspace.photos.urls")),
...
ui_urlpatterns = [
    ...
    path("photos", include("workspace.photos.ui.urls")),
    ...
    path("people", include("workspace.people.ui.urls")),
