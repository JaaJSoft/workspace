...
def _get_profile_activity_context(
    ...
    return {
        ...
        "activity_base_url": reverse(
            "users_ui:profile_activity_feed", kwargs={"username": username}
        ),
    }
...
def profile_view(request, username=None):
    if username is None:
        ...
        try:
            profile_user = User.objects.get(
                username=username, is_active=True, bot_profile__isnull=True
            )
    ...
    banner_gradient = gradient_from_palette_value(
        profile_settings.get("banner_palette")
    )
    ...
    context = {
        ...
        "activity_prefix": "profile-activity",
        "activity_base_url": reverse(
            "users_ui:profile_activity_feed", kwargs={"username": profile_user.username}
        ),
    }
