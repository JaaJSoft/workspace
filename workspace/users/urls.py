...
urlpatterns = [
    ...
    path(
        "api/v1/auth/tokens",
        views.APITokenListCreateView.as_view(),
        name="api-token-list-create",
    ),
    path(
        "api/v1/auth/tokens/<str:pk>",
        views.APITokenDetailView.as_view(),
    ...
    path(
        "api/v1/users/<int:user_id>/avatar",
        views.UserAvatarRetrieveView.as_view(),
        name="user-avatar-retrieve",
    ),
    path(
        "api/v1/users/password-rules",
        views.PasswordRulesView.as_view(),
    ...
    path(
        "api/v1/settings/<str:module>",
        views.SettingsModuleView.as_view(),
        name="settings-module",
    ),
    path(
        "api/v1/settings/<str:module>/<str:key>",
        views.SettingDetailView.as_view(),
        name="setting-detail",
    ),
]
