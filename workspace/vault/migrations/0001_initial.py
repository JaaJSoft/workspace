...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='folder',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='entries', to='vault.vaultfolder'),
        ),
        migrations.CreateModel(
            name='VaultKeyWrap',
            fields=[
        ...
        migrations.AddConstraint(
            model_name='vault',
            constraint=models.CheckConstraint(condition=models.Q(('metadata_sig', ''), _negated=True), name='vault_metadata_sig_not_empty'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            model_name='vaultentry',
            constraint=models.CheckConstraint(condition=models.Q(('metadata_sig', ''), _negated=True), name='entry_metadata_sig_not_empty'),
        ),
    ]
