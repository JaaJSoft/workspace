// The geometry of a tile grid.
//
// The five steps of the slider, as the file browser draws them: a minimum
// column width, the gap between tiles, and the icon inside. Which step is in
// use is a per-device preference; the steps themselves are this one list.
window.vaultTiles = {
  STEPS: {
